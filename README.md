...
Atualmente curso **Ciência da Computação** e estou construindo minha base como programador através de estudos, projetos pessoais, exercícios e, principalmente, muita prática.

Tenho interesse especial por **programação e desenvolvimento de jogos**. Criar jogos começou como uma forma de aprender programação na prática e acabou se tornando um dos meus principais hobbies.

Gosto de entender **como as coisas funcionam por trás do código**, testar ideias e transformar conceitos que aprendo em pequenos projetos.
...
Não quero aprender programação apenas lendo teoria.

Minha forma de aprendizado envolve criar, testar e resolver problemas.
...
Por isso, alguns dos meus repositórios podem conter código simples, experimentos ou soluções que poderiam ser feitas de maneiras melhores.
...
Este perfil não representa apenas o que eu já sei.

Ele representa principalmente **o que estou aprendendo a fazer**.
